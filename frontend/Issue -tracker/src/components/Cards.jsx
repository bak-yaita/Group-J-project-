...
const Cards = ( {title, number}) => {
  return (
    <div>
        <a href="#" class="block max-w-sm p-6 bg-white border border-gray-200  shadow-sm hover:bg-gray-100 dark:bg-blue-950 dark:border-gray-700 dark:hover:bg-gray-700">
